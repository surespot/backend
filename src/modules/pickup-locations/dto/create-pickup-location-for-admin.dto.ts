...
/**
 * DTO used when creating a pickup location that will be
 * attached to an existing admin user (no new user is created).
 */
export class CreatePickupLocationForAdminDto {
  @ApiProperty({
